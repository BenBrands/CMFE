...
template <int dim>
class IncompressibleOgden : public BaseMaterial<dim>
{
private:
...
public:
	...
	IncompressibleOgden(const Vector<double> alpha,
						   const Vector<double> mu, const double B, const double alpha_vol);

	virtual ~IncompressibleOgden() {}
