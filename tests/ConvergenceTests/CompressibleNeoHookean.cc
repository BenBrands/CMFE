...
int main()
{
	...
	const std::string material_parameter_file(std::string(SOURCE_DIR) + "/CompressibleNeoHookean.prm");

	const Tensor<2,dim> tensor_F_0 = Physics::Elasticity::StandardTensors<dim>::I;

	Tensor<2,dim> tensor_F_inf;

	tensor_F_inf[0][0] = 1.05; tensor_F_inf[1][1] = 1.08; tensor_F_inf[2][2] = 0.9;
